...
public class DataSeeder implements CommandLineRunner {
    ...
    @Autowired
    private BlogPostRepository blogPostRepository; // <-- Nuevo Repositorio
    ...
    public void run(String... args) throws Exception {
        cargarUsuarios();
        cargarProductos();
        cargarBlogs(); // <-- Ejecutamos la carga de blogs
    }
    ...
    private void cargarProductos() {
        if (productoRepository.count() == 0) {
            ...
            crearProducto("TC001", "tortas-cuadradas", "Torta Cuadrada de Chocolate", 45000, 
                ...
                "img/torta-cuadrada-chocolate-ganache.jpg", "fa-solid fa-birthday-cake", true);
            ...
            crearProducto("TC002", "tortas-cuadradas", "Torta Cuadrada de Frutas", 50000, 
                ...
                "img/torta-cuadrada-frutas-crema-chantilly.jpg", "fa-solid fa-birthday-cake", true);
            ...
            crearProducto("TT001", "tortas-circulares", "Torta Circular de Vainilla", 40000, 
                ...
                "img/torta-circular-vainilla.jpg", "fa-solid fa-birthday-cake", true);
            ...
            crearProducto("TT002", "tortas-circulares", "Torta Circular de Manjar", 42000, 
                ...
                "img/torta-circular-manjar.jpg", "fa-solid fa-birthday-cake", true);
            ...
            crearProducto("PI001", "postres-individuales", "Mousse de Chocolate", 5000, 
                ...
                "img/mousse-chocolate-cremoso-individual.jpg", "fa-solid fa-ice-cream", false);
            ...
            crearProducto("PI002", "postres-individuales", "Tiramisú Clásico", 5500, 
                ...
                "img/tiramisu-italiano-cafe-mascarpone.jpg", "fa-solid fa-ice-cream", false);
            ...
            crearProducto("PSA001", "sin-azucar", "Torta Sin Azúcar de Naranja", 48000, 
                ...
                "img/torta-naranja-sin-azucar-saludable.jpg", "fa-solid fa-leaf", true);
            ...
            crearProducto("PSA002", "sin-azucar", "Cheesecake Sin Azúcar", 47000, 
                ...
                "img/cheesecake.jpg", "fa-solid fa-leaf", true);
            ...
            crearProducto("PT001", "tradicional", "Empanada de Manzana", 3000, 
                ...
                "img/empanadas-manzana.jpg", "fa-solid fa-bread-slice", false);
            ...
            crearProducto("PT002", "tradicional", "Tarta de Santiago", 6000, 
                ...
                "img/tarta-santiago-almendras-espa-ola.jpg", "fa-solid fa-bread-slice", false);
            ...
            crearProducto("PG002", "sin-gluten", "Pan Sin Gluten", 3500, 
                ...
                "img/pan-sin-gluten-esponjoso.jpg", "fa-solid fa-wheat-awn-circle-exclamation", false);
            ...
            crearProducto("PV001", "vegana", "Torta Vegana de Chocolate", 50000, 
                ...
                "img/torta-vegana-chocolate-sin-productos-animales.jpg", "fa-solid fa-seedling", true);
            ...
            crearProducto("PV002", "vegana", "Galletas Veganas de Avena", 4500, 
                ...
                "img/galletas-veganas-avena-crujientes.jpg", "fa-solid fa-seedling", false);
            ...
            crearProducto("TE001", "especiales", "Torta Especial de Cumpleaños", 55000, 
                ...
                "img/torta-cumplea-os-especial-decorada-personalizada.jpg", "fa-solid fa-gift", true);
            ...
            crearProducto("TE002", "especiales", "Torta Especial de Boda", 60000, 
                ...
                "img/torta-boda-especial.jpg", "fa-solid fa-gift", true);
    ...
    private void cargarBlogs() {
        if (blogPostRepository.count() == 0) {
            ...
            crearBlog("Secretos para el Bizcocho Perfecto", "recetas", "2025-01-15", "Chef María González", 
                "img/blog-bizcocho-perfecto.jpg", "Descubre los trucos profesionales para lograr un bizcocho esponjoso y delicioso en casa.",
            ...
            crearBlog("Nueva Sucursal en Concepción Centro", "noticias", "2025-01-10", "Equipo Mil Sabores", 
                "img/blog-nueva-sucursal.jpg", "Estamos emocionados de anunciar la apertura de nuestra nueva sucursal en el corazón de Concepción.",
            ...
            crearBlog("Cómo Conservar Tortas Frescas por Más Tiempo", "consejos", "2025-01-08", "Chef Carlos Mendoza", 
                "img/blog-conservar-tortas.jpg", "Tips profesionales para mantener tus tortas frescas y deliciosas durante más días.",
            ...
            crearBlog("Taller de Repostería para Principiantes", "eventos", "2025-01-05", "Equipo Mil Sabores", 
                "img/blog-taller-reposteria.jpg", "Únete a nuestro taller mensual donde aprenderás las técnicas básicas de la repostería.",
            ...
            crearBlog("Ganache de Chocolate: La Receta Definitiva", "recetas", "2025-01-03", "Chef Ana Rodríguez", 
                "img/blog-ganache-chocolate.jpg", "Aprende a preparar el ganache de chocolate perfecto para tus tortas y postres.",
            ...
            crearBlog("Nuevos Sabores de Temporada", "noticias", "2025-01-01", "Equipo Mil Sabores", 
                "img/blog-sabores-temporada.jpg", "Descubre nuestros nuevos sabores inspirados en los frutos de la temporada de verano.",
                "<h4>Sabores que Celebran el Verano</h4><p>Con la llegada del verano, hemos creado una línea especial...</p>");

            crearBlog("Alianza Culinaria: Mil Sabores y los Futuros Talentos del DuocUC", "eventos", "2025-02-28", "Equipo Mil Sabores", 
                "img/blog-duocuc.jpg", "Descubre cómo nuestra pastelería se une a los estudiantes de gastronomía del DuocUC.",
    ...
    private void crearProducto(String codigo, String categoria, String nombre, Integer precio, 
                             String descripcion, String imagen, String icono, Boolean personalizable) {
